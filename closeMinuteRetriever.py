...
def minuteRetrieve(startTime, endTime,futures,fields = ['close'], option = "MA_N=5;", table = "factors_minute"):
    # Start Wind API
    w.start()
...
minuteRetrieve("2015-04-20 09:00:00", "2017-04-30 15:00:00",
...
['open','high','low','close','volume','amt','chg','pct_chg','oi','MA'],option = "MA_N=5;")