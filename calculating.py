...
calculate_mmt(datetime.date(2017,4,28), datetime.date(2017,5,31))
calculate_Yield(datetime.date(2017,4,28), datetime.date(2017,5,31))
calculate_mfd_sum(datetime.date(2017,5,1), datetime.date(2017,5,31),factors=['mfd_buyamt_d1', 'mfd_sellamt_d1','mfd_buyamt_d4', 'mfd_sellamt_d4'])