...
calculate_mmt(datetime.date(2017,2,26), datetime.date(2017,5,26))
calculate_Yield(datetime.date(2017,1,26), datetime.date(2017,5,26))
# calculate_mfd_sum(datetime.date(2017,5,1), datetime.date(2017,5,26),factors=['mfd_buyamt_d1', 'mfd_sellamt_d1','mfd_buyamt_d4', 'mfd_sellamt_d4'])