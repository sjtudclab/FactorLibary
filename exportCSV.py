...
export('E:\\train-2017.csv', datetime.date(2017,3,1),datetime.date(2017,4,30),factors=['mkt_freeshares_rank', 'mmt_rank', 'mfd_buyamt_d_rank', 'mfd_buyamt_d4_rank','Yield_rank'])